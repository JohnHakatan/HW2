...
assert(table.find(player128.getID())==nullptr);
assert(table.find(player141.getID())!=nullptr);
...
assert(table.remove(player133.getID())==FAILURE);
...
assert(table.remove(player127.getID())==FAILURE);
...
assert(table.remove(player128.getID())==FAILURE);
assert(table.remove(player102.getID())==FAILURE);
...
assert(table.find(player147.getID())!=nullptr);
assert(table.insert(player120.getID(), &player120)==SUCCESS);
assert(table.remove(player5.getID())==FAILURE);
assert(table.remove(player35.getID())==FAILURE);
assert(table.insert(player123.getID(), &player123)==FAILURE);
...
assert(table.find(player134.getID())==nullptr);
assert(table.find(player106.getID())!=nullptr);
...
assert(table.insert(player104.getID(), &player104)==FAILURE);
assert(table.find(player19.getID())==nullptr);
...
assert(table.find(player73.getID())==nullptr);
assert(table.remove(player66.getID())==SUCCESS);
assert(table.remove(player66.getID())==FAILURE);
assert(table.find(player148.getID())==nullptr);
assert(table.remove(player49.getID())==FAILURE);
assert(table.find(player19.getID())==nullptr);
assert(table.remove(player10.getID())==FAILURE);
assert(table.find(player141.getID())!=nullptr);
assert(table.remove(player1.getID())==FAILURE);
assert(table.insert(player105.getID(), &player105)==FAILURE);
assert(table.remove(player67.getID())==FAILURE);
assert(table.remove(player103.getID())==FAILURE);
assert(table.insert(player120.getID(), &player120)==FAILURE);
...
assert(table.remove(player94.getID())==FAILURE);
assert(table.remove(player23.getID())==FAILURE);
assert(table.remove(player23.getID())==FAILURE);
...
assert(table.remove(player125.getID())==FAILURE);
...
assert(table.find(player134.getID())==nullptr);
assert(table.find(player43.getID())==nullptr);
assert(table.insert(player137.getID(), &player137)==FAILURE);
...
assert(table.find(player14.getID())==nullptr);
assert(table.remove(player129.getID())==FAILURE);
...
assert(table.find(player69.getID())==nullptr);
assert(table.remove(player130.getID())==FAILURE);
...
assert(table.find(player143.getID())==nullptr);
...
assert(table.find(player100.getID())==nullptr);
assert(table.insert(player60.getID(), &player60)==FAILURE);
...
assert(table.remove(player18.getID())==FAILURE);
assert(table.insert(player105.getID(), &player105)==FAILURE);
assert(table.find(player125.getID())==nullptr);
assert(table.remove(player92.getID())==SUCCESS);
assert(table.insert(player136.getID(), &player136)==FAILURE);
assert(table.insert(player35.getID(), &player35)==SUCCESS);
assert(table.remove(player72.getID())==FAILURE);
assert(table.remove(player25.getID())==FAILURE);
assert(table.remove(player118.getID())==FAILURE);
...
assert(table.find(player119.getID())==nullptr);
...
assert(table.remove(player145.getID())==FAILURE);
assert(table.remove(player112.getID())==FAILURE);
...
assert(table.remove(player94.getID())==FAILURE);
assert(table.remove(player115.getID())==FAILURE);
assert(table.find(player122.getID())==nullptr);
...
assert(table.insert(player93.getID(), &player93)==FAILURE);
assert(table.remove(player131.getID())==FAILURE);
assert(table.insert(player4.getID(), &player4)==FAILURE);
assert(table.insert(player60.getID(), &player60)==SUCCESS);
assert(table.find(player107.getID())==nullptr);
assert(table.insert(player132.getID(), &player132)==FAILURE);
assert(table.insert(player131.getID(), &player131)==SUCCESS);
assert(table.insert(player92.getID(), &player92)==SUCCESS);
assert(table.find(player129.getID())==nullptr);
...
assert(table.find(player96.getID())==nullptr);
assert(table.remove(player70.getID())==FAILURE);
assert(table.find(player121.getID())==nullptr);
...
assert(table.insert(player124.getID(), &player124)==FAILURE);
assert(table.find(player33.getID())==nullptr);
assert(table.insert(player71.getID(), &player71)==FAILURE);
...
assert(table.remove(player69.getID())==FAILURE);
assert(table.insert(player148.getID(), &player148)==FAILURE);
assert(table.find(player47.getID())!=nullptr);
assert(table.remove(player25.getID())==FAILURE);
assert(table.remove(player129.getID())==FAILURE);
assert(table.insert(player65.getID(), &player65)==SUCCESS);
...
assert(table.find(player135.getID())==nullptr);
...
assert(table.find(player118.getID())==nullptr);
assert(table.remove(player116.getID())==FAILURE);
...
assert(table.insert(player127.getID(), &player127)==FAILURE);
assert(table.find(player138.getID())!=nullptr);
assert(table.remove(player38.getID())==FAILURE);
assert(table.remove(player22.getID())==FAILURE);
...
assert(table.find(player105.getID())!=nullptr);
...
assert(table.find(player108.getID())==nullptr);
assert(table.insert(player66.getID(), &player66)==SUCCESS);
...
assert(table.find(player109.getID())!=nullptr);
assert(table.remove(player139.getID())==FAILURE);
...
assert(table.insert(player44.getID(), &player44)==FAILURE);
...
assert(table.insert(player135.getID(), &player135)==FAILURE);
assert(table.remove(player24.getID())==FAILURE);
assert(table.insert(player4.getID(), &player4)==FAILURE);
assert(table.remove(player32.getID())==SUCCESS);
assert(table.remove(player39.getID())==FAILURE);
assert(table.find(player130.getID())==nullptr);
...
assert(table.remove(player147.getID())==FAILURE);
assert(table.remove(player6.getID())==SUCCESS);
assert(table.find(player127.getID())!=nullptr);
...
assert(table.find(player130.getID())!=nullptr);
assert(table.find(player84.getID())==nullptr);
assert(table.find(player137.getID())!=nullptr);
...
assert(table.insert(player138.getID(), &player138)==SUCCESS);
assert(table.insert(player140.getID(), &player140)==FAILURE);
assert(table.find(player68.getID())==nullptr);
assert(table.find(player125.getID())!=nullptr);
assert(table.find(player51.getID())!=nullptr);
assert(table.find(player112.getID())==nullptr);
assert(table.insert(player115.getID(), &player115)==SUCCESS);
assert(table.find(player10.getID())==nullptr);
assert(table.insert(player6.getID(), &player6)==SUCCESS);
assert(table.insert(player103.getID(), &player103)==FAILURE);
assert(table.insert(player128.getID(), &player128)==FAILURE);
assert(table.find(player144.getID())==nullptr);
assert(table.find(player49.getID())!=nullptr);
...
assert(table.remove(player143.getID())==FAILURE);
assert(table.remove(player115.getID())==SUCCESS);
assert(table.find(player90.getID())==nullptr);
assert(table.remove(player115.getID())==FAILURE);
assert(table.insert(player42.getID(), &player42)==SUCCESS);
assert(table.find(player123.getID())!=nullptr);
assert(table.find(player30.getID())==nullptr);
assert(table.remove(player111.getID())==FAILURE);
assert(table.find(player132.getID())!=nullptr);
assert(table.find(player111.getID())==nullptr);
assert(table.remove(player117.getID())==FAILURE);
assert(table.find(player36.getID())==nullptr);
assert(table.insert(player48.getID(), &player48)==SUCCESS);
assert(table.find(player72.getID())==nullptr);
assert(table.remove(player29.getID())==FAILURE);
assert(table.insert(player34.getID(), &player34)==FAILURE);
assert(table.remove(player63.getID())==FAILURE);
assert(table.find(player138.getID())!=nullptr);
assert(table.remove(player102.getID())==FAILURE);
assert(table.remove(player101.getID())==SUCCESS);
assert(table.remove(player35.getID())==FAILURE);
assert(table.insert(player130.getID(), &player130)==FAILURE);
assert(table.find(player36.getID())==nullptr);
...
assert(table.remove(player15.getID())==FAILURE);
...
assert(table.find(player50.getID())!=nullptr);
assert(table.find(player73.getID())!=nullptr);
assert(table.find(player101.getID())==nullptr);
assert(table.find(player14.getID())!=nullptr);
assert(table.insert(player129.getID(), &player129)==SUCCESS);
assert(table.insert(player92.getID(), &player92)==FAILURE);
assert(table.remove(player64.getID())==FAILURE);
assert(table.remove(player142.getID())==FAILURE);
assert(table.remove(player117.getID())==FAILURE);
...
assert(table.find(player28.getID())==nullptr);
assert(table.insert(player132.getID(), &player132)==FAILURE);
assert(table.insert(player36.getID(), &player36)==FAILURE);
...
assert(table.remove(player90.getID())==FAILURE);
assert(table.find(player127.getID())!=nullptr);
assert(table.find(player41.getID())==nullptr);
assert(table.find(player126.getID())!=nullptr);
assert(table.find(player108.getID())!=nullptr);
assert(table.remove(player113.getID())==FAILURE);
assert(table.remove(player72.getID())==FAILURE);
assert(table.insert(player32.getID(), &player32)==SUCCESS);
...
assert(table.find(player136.getID())!=nullptr);
...
assert(table.find(player77.getID())==nullptr);
assert(table.find(player117.getID())==nullptr);
assert(table.find(player112.getID())==nullptr);
assert(table.insert(player93.getID(), &player93)==FAILURE);
assert(table.find(player97.getID())==nullptr);
...
assert(table.find(player114.getID())==nullptr);
assert(table.find(player72.getID())==nullptr);
assert(table.insert(player48.getID(), &player48)==FAILURE);
assert(table.remove(player149.getID())==FAILURE);
...
assert(table.insert(player62.getID(), &player62)==FAILURE);
assert(table.insert(player31.getID(), &player31)==FAILURE);
assert(table.find(player28.getID())==nullptr);
assert(table.remove(player64.getID())==FAILURE);
assert(table.remove(player94.getID())==SUCCESS);
assert(table.remove(player106.getID())==FAILURE);
...
assert(table.find(player82.getID())!=nullptr);
assert(table.find(player85.getID())==nullptr);
...
assert(table.remove(player24.getID())==FAILURE);
assert(table.find(player113.getID())!=nullptr);
assert(table.find(player48.getID())!=nullptr);
assert(table.find(player104.getID())!=nullptr);
assert(table.find(player17.getID())==nullptr);
assert(table.insert(player94.getID(), &player94)==SUCCESS);
assert(table.insert(player90.getID(), &player90)==SUCCESS);
assert(table.find(player76.getID())!=nullptr);
assert(table.insert(player115.getID(), &player115)==SUCCESS);
assert(table.find(player126.getID())!=nullptr);
assert(table.remove(player139.getID())==FAILURE);
assert(table.insert(player38.getID(), &player38)==SUCCESS);
...
assert(table.find(player62.getID())!=nullptr);
assert(table.insert(player94.getID(), &player94)==FAILURE);
...
assert(table.find(player102.getID())==nullptr);
assert(table.remove(player83.getID())==FAILURE);
assert(table.find(player147.getID())==nullptr);
assert(table.find(player145.getID())==nullptr);
...
assert(table.find(player97.getID())==nullptr);
assert(table.insert(player47.getID(), &player47)==SUCCESS);
assert(table.remove(player135.getID())==FAILURE);
assert(table.find(player32.getID())==nullptr);
assert(table.remove(player98.getID())==SUCCESS);
assert(table.remove(player1.getID())==FAILURE);
assert(table.find(player88.getID())!=nullptr);
...
assert(table.insert(player141.getID(), &player141)==FAILURE);
assert(table.insert(player119.getID(), &player119)==SUCCESS);
assert(table.remove(player95.getID())==FAILURE);
assert(table.insert(player110.getID(), &player110)==SUCCESS);
assert(table.insert(player138.getID(), &player138)==FAILURE);
assert(table.insert(player11.getID(), &player11)==SUCCESS);
assert(table.remove(player10.getID())==FAILURE);
assert(table.remove(player66.getID())==SUCCESS);
assert(table.insert(player94.getID(), &player94)==FAILURE);
assert(table.insert(player98.getID(), &player98)==SUCCESS);
assert(table.insert(player108.getID(), &player108)==FAILURE);
assert(table.remove(player119.getID())==SUCCESS);
assert(table.remove(player21.getID())==SUCCESS);
assert(table.find(player51.getID())!=nullptr);
assert(table.remove(player94.getID())==SUCCESS);
assert(table.insert(player19.getID(), &player19)==FAILURE);
...
assert(table.insert(player119.getID(), &player119)==SUCCESS);
assert(table.find(player72.getID())==nullptr);
assert(table.insert(player88.getID(), &player88)==FAILURE);
assert(table.remove(player74.getID())==SUCCESS);
assert(table.remove(player40.getID())==SUCCESS);
assert(table.insert(player119.getID(), &player119)==FAILURE);
assert(table.remove(player39.getID())==FAILURE);
...
assert(table.insert(player26.getID(), &player26)==FAILURE);
assert(table.find(player61.getID())!=nullptr);
...
assert(table.find(player133.getID())==nullptr);
assert(table.find(player147.getID())==nullptr);
assert(table.remove(player124.getID())==FAILURE);
assert(table.insert(player52.getID(), &player52)==SUCCESS);
assert(table.insert(player132.getID(), &player132)==SUCCESS);
assert(table.find(player76.getID())==nullptr);
assert(table.find(player31.getID())!=nullptr);
assert(table.insert(player106.getID(), &player106)==FAILURE);
assert(table.insert(player32.getID(), &player32)==SUCCESS);
assert(table.find(player111.getID())==nullptr);
assert(table.find(player63.getID())!=nullptr);
assert(table.remove(player98.getID())==SUCCESS);
...
assert(table.find(player58.getID())==nullptr);
assert(table.find(player92.getID())!=nullptr);
assert(table.find(player1.getID())==nullptr);
assert(table.insert(player107.getID(), &player107)==SUCCESS);
assert(table.insert(player126.getID(), &player126)==FAILURE);
assert(table.find(player34.getID())!=nullptr);
assert(table.find(player108.getID())!=nullptr);
assert(table.remove(player146.getID())==FAILURE);
assert(table.find(player29.getID())==nullptr);
assert(table.remove(player64.getID())==FAILURE);
...
assert(table.remove(player39.getID())==FAILURE);
assert(table.find(player147.getID())==nullptr);
assert(table.insert(player77.getID(), &player77)==FAILURE);
...
assert(table.remove(player6.getID())==SUCCESS);
assert(table.insert(player11.getID(), &player11)==FAILURE);
assert(table.insert(player71.getID(), &player71)==FAILURE);
assert(table.find(player105.getID())==nullptr);
assert(table.insert(player112.getID(), &player112)==SUCCESS);
assert(table.find(player33.getID())==nullptr);
assert(table.find(player42.getID())==nullptr);
assert(table.insert(player20.getID(), &player20)==FAILURE);
assert(table.insert(player93.getID(), &player93)==FAILURE);
assert(table.find(player115.getID())!=nullptr);
assert(table.find(player126.getID())!=nullptr);
assert(table.insert(player59.getID(), &player59)==SUCCESS);
assert(table.remove(player149.getID())==FAILURE);
assert(table.remove(player35.getID())==FAILURE);
...
assert(table.find(player46.getID())==nullptr);
assert(table.remove(player101.getID())==FAILURE);
assert(table.remove(player40.getID())==FAILURE);
assert(table.find(player130.getID())!=nullptr);
assert(table.remove(player131.getID())==FAILURE);
assert(table.insert(player21.getID(), &player21)==SUCCESS);
...
assert(table.remove(player105.getID())==SUCCESS);
assert(table.find(player139.getID())!=nullptr);
assert(table.find(player131.getID())==nullptr);
assert(table.remove(player108.getID())==SUCCESS);
assert(table.find(player127.getID())!=nullptr);
...
assert(table.insert(player34.getID(), &player34)==FAILURE);
assert(table.remove(player144.getID())==FAILURE);
assert(table.find(player54.getID())!=nullptr);
assert(table.find(player113.getID())==nullptr);
...
assert(table.find(player39.getID())!=nullptr);
assert(table.find(player46.getID())==nullptr);
assert(table.insert(player117.getID(), &player117)==FAILURE);
assert(table.find(player83.getID())!=nullptr);
assert(table.find(player106.getID())!=nullptr);
...
assert(table.find(player146.getID())!=nullptr);
assert(table.find(player38.getID())!=nullptr);
assert(table.insert(player107.getID(), &player107)==FAILURE);
...
assert(table.insert(player75.getID(), &player75)==FAILURE);
assert(table.find(player13.getID())!=nullptr);
assert(table.find(player128.getID())!=nullptr);
assert(table.insert(player64.getID(), &player64)==SUCCESS);
assert(table.find(player118.getID())!=nullptr);
assert(table.find(player62.getID())!=nullptr);
assert(table.remove(player108.getID())==FAILURE);
assert(table.insert(player77.getID(), &player77)==FAILURE);
assert(table.remove(player86.getID())==FAILURE);
assert(table.remove(player33.getID())==FAILURE);
assert(table.insert(player55.getID(), &player55)==SUCCESS);
...
assert(table.find(player13.getID())!=nullptr);
assert(table.remove(player82.getID())==SUCCESS);
assert(table.remove(player137.getID())==FAILURE);
assert(table.remove(player115.getID())==SUCCESS);
assert(table.find(player55.getID())!=nullptr);
assert(table.remove(player23.getID())==FAILURE);
...
assert(table.insert(player105.getID(), &player105)==SUCCESS);
assert(table.remove(player26.getID())==FAILURE);
assert(table.insert(player125.getID(), &player125)==SUCCESS);
assert(table.insert(player117.getID(), &player117)==FAILURE);
assert(table.remove(player25.getID())==FAILURE);
assert(table.find(player106.getID())==nullptr);
...
assert(table.remove(player87.getID())==SUCCESS);
assert(table.remove(player26.getID())==FAILURE);
assert(table.insert(player116.getID(), &player116)==FAILURE);
assert(table.insert(player76.getID(), &player76)==SUCCESS);
assert(table.find(player36.getID())!=nullptr);
assert(table.insert(player16.getID(), &player16)==SUCCESS);
assert(table.find(player123.getID())!=nullptr);
...
assert(table.insert(player3.getID(), &player3)==SUCCESS);
assert(table.find(player128.getID())==nullptr);
assert(table.remove(player132.getID())==FAILURE);
assert(table.find(player96.getID())==nullptr);
...
assert(table.insert(player73.getID(), &player73)==FAILURE);
assert(table.insert(player90.getID(), &player90)==FAILURE);
...
assert(table.find(player105.getID())!=nullptr);
assert(table.find(player14.getID())!=nullptr);
assert(table.remove(player41.getID())==FAILURE);
assert(table.insert(player134.getID(), &player134)==FAILURE);
assert(table.find(player49.getID())==nullptr);
assert(table.remove(player81.getID())==FAILURE);
assert(table.find(player46.getID())==nullptr);
assert(table.find(player106.getID())==nullptr);
...
assert(table.find(player88.getID())!=nullptr);
assert(table.insert(player37.getID(), &player37)==SUCCESS);
assert(table.insert(player109.getID(), &player109)==FAILURE);
...
assert(table.insert(player132.getID(), &player132)==SUCCESS);
assert(table.insert(player11.getID(), &player11)==FAILURE);
assert(table.find(player120.getID())==nullptr);
assert(table.remove(player124.getID())==SUCCESS);
assert(table.find(player62.getID())!=nullptr);
assert(table.find(player98.getID())==nullptr);
assert(table.remove(player97.getID())==FAILURE);
...
assert(table.insert(player67.getID(), &player67)==SUCCESS);
assert(table.insert(player67.getID(), &player67)==FAILURE);
assert(table.remove(player47.getID())==FAILURE);
assert(table.find(player131.getID())==nullptr);
assert(table.insert(player108.getID(), &player108)==SUCCESS);
assert(table.find(player47.getID())==nullptr);
assert(table.remove(player142.getID())==FAILURE);
...
assert(table.remove(player26.getID())==SUCCESS);
assert(table.find(player142.getID())==nullptr);
assert(table.insert(player115.getID(), &player115)==FAILURE);
assert(table.insert(player132.getID(), &player132)==FAILURE);
assert(table.insert(player43.getID(), &player43)==FAILURE);
assert(table.find(player147.getID())!=nullptr);
assert(table.insert(player45.getID(), &player45)==FAILURE);
assert(table.find(player71.getID())!=nullptr);
assert(table.insert(player102.getID(), &player102)==FAILURE);
assert(table.insert(player16.getID(), &player16)==SUCCESS);
assert(table.remove(player134.getID())==SUCCESS);
assert(table.remove(player132.getID())==SUCCESS);
assert(table.find(player147.getID())!=nullptr);
...
assert(table.find(player109.getID())!=nullptr);
assert(table.insert(player117.getID(), &player117)==FAILURE);
assert(table.remove(player138.getID())==FAILURE);
assert(table.remove(player97.getID())==FAILURE);
...
assert(table.find(player134.getID())==nullptr);
assert(table.find(player91.getID())!=nullptr);
assert(table.insert(player110.getID(), &player110)==FAILURE);
assert(table.insert(player66.getID(), &player66)==FAILURE);
assert(table.remove(player25.getID())==SUCCESS);
assert(table.find(player82.getID())!=nullptr);
assert(table.insert(player105.getID(), &player105)==SUCCESS);
assert(table.insert(player133.getID(), &player133)==FAILURE);
assert(table.remove(player149.getID())==SUCCESS);
...
assert(table.find(player63.getID())!=nullptr);
assert(table.find(player147.getID())!=nullptr);
assert(table.insert(player118.getID(), &player118)==FAILURE);
assert(table.remove(player49.getID())==FAILURE);
assert(table.remove(player108.getID())==SUCCESS);
assert(table.find(player88.getID())==nullptr);
assert(table.remove(player48.getID())==SUCCESS);
...
assert(table.remove(player82.getID())==SUCCESS);
assert(table.find(player41.getID())==nullptr);
assert(table.find(player124.getID())==nullptr);
assert(table.insert(player32.getID(), &player32)==SUCCESS);
assert(table.remove(player39.getID())==FAILURE);
assert(table.find(player100.getID())!=nullptr);
...
assert(table.find(player30.getID())!=nullptr);
assert(table.insert(player111.getID(), &player111)==FAILURE);
assert(table.insert(player66.getID(), &player66)==FAILURE);
assert(table.remove(player86.getID())==FAILURE);
assert(table.find(player69.getID())!=nullptr);
assert(table.find(player74.getID())!=nullptr);
...
assert(table.insert(player140.getID(), &player140)==FAILURE);
assert(table.remove(player27.getID())==SUCCESS);
assert(table.insert(player52.getID(), &player52)==FAILURE);
assert(table.insert(player128.getID(), &player128)==SUCCESS);
assert(table.insert(player65.getID(), &player65)==FAILURE);
assert(table.remove(player143.getID())==FAILURE);
assert(table.remove(player125.getID())==SUCCESS);
...
assert(table.find(player118.getID())!=nullptr);
assert(table.find(player146.getID())==nullptr);
assert(table.remove(player122.getID())==FAILURE);
assert(table.insert(player92.getID(), &player92)==SUCCESS);
assert(table.find(player83.getID())==nullptr);
assert(table.find(player110.getID())!=nullptr);
assert(table.find(player97.getID())==nullptr);
...
assert(table.remove(player46.getID())==FAILURE);
assert(table.insert(player145.getID(), &player145)==SUCCESS);
assert(table.insert(player121.getID(), &player121)==FAILURE);
assert(table.remove(player72.getID())==FAILURE);
assert(table.find(player141.getID())!=nullptr);
assert(table.insert(player39.getID(), &player39)==FAILURE);
assert(table.insert(player87.getID(), &player87)==SUCCESS);
assert(table.find(player70.getID())==nullptr);
assert(table.remove(player148.getID())==FAILURE);
assert(table.find(player129.getID())==nullptr);
assert(table.insert(player68.getID(), &player68)==SUCCESS);
assert(table.remove(player51.getID())==FAILURE);
assert(table.insert(player142.getID(), &player142)==FAILURE);
assert(table.remove(player6.getID())==SUCCESS);
assert(table.insert(player40.getID(), &player40)==SUCCESS);
...
assert(table.find(player84.getID())==nullptr);
assert(table.remove(player105.getID())==SUCCESS);
assert(table.insert(player131.getID(), &player131)==FAILURE);
assert(table.find(player92.getID())==nullptr);
assert(table.find(player35.getID())==nullptr);
assert(table.find(player31.getID())!=nullptr);
assert(table.remove(player4.getID())==FAILURE);
...
assert(table.find(player21.getID())==nullptr);
assert(table.insert(player141.getID(), &player141)==FAILURE);
assert(table.insert(player64.getID(), &player64)==FAILURE);
assert(table.find(player71.getID())!=nullptr);
assert(table.insert(player113.getID(), &player113)==SUCCESS);
assert(table.find(player113.getID())!=nullptr);
assert(table.find(player143.getID())==nullptr);
...
assert(table.remove(player62.getID())==SUCCESS);
assert(table.remove(player20.getID())==FAILURE);
assert(table.find(player116.getID())==nullptr);
assert(table.insert(player76.getID(), &player76)==SUCCESS);
assert(table.find(player149.getID())==nullptr);
assert(table.insert(player129.getID(), &player129)==SUCCESS);
assert(table.find(player11.getID())!=nullptr);
assert(table.insert(player124.getID(), &player124)==SUCCESS);
assert(table.insert(player25.getID(), &player25)==SUCCESS);
assert(table.insert(player100.getID(), &player100)==FAILURE);
assert(table.insert(player137.getID(), &player137)==SUCCESS);
assert(table.insert(player67.getID(), &player67)==FAILURE);
assert(table.find(player98.getID())!=nullptr);
assert(table.find(player135.getID())==nullptr);
...
assert(table.insert(player102.getID(), &player102)==SUCCESS);
assert(table.remove(player119.getID())==FAILURE);
assert(table.remove(player116.getID())==FAILURE);
assert(table.find(player133.getID())==nullptr);
assert(table.remove(player58.getID())==FAILURE);
assert(table.insert(player135.getID(), &player135)==SUCCESS);
...
assert(table.find(player122.getID())==nullptr);
assert(table.insert(player75.getID(), &player75)==SUCCESS);
assert(table.insert(player96.getID(), &player96)==FAILURE);
assert(table.find(player137.getID())!=nullptr);
...
assert(table.remove(player138.getID())==FAILURE);
assert(table.remove(player23.getID())==FAILURE);
assert(table.insert(player114.getID(), &player114)==FAILURE);
assert(table.insert(player61.getID(), &player61)==FAILURE);
assert(table.remove(player122.getID())==FAILURE);
assert(table.remove(player113.getID())==SUCCESS);
assert(table.insert(player47.getID(), &player47)==FAILURE);
...
assert(table.remove(player37.getID())==SUCCESS);
assert(table.remove(player70.getID())==FAILURE);
assert(table.insert(player30.getID(), &player30)==FAILURE);
assert(table.insert(player134.getID(), &player134)==SUCCESS);
assert(table.remove(player127.getID())==FAILURE);
assert(table.insert(player64.getID(), &player64)==FAILURE);
assert(table.remove(player137.getID())==SUCCESS);
...
assert(table.insert(player7.getID(), &player7)==SUCCESS);
assert(table.insert(player92.getID(), &player92)==SUCCESS);
assert(table.find(player140.getID())!=nullptr);
assert(table.remove(player21.getID())==SUCCESS);
assert(table.remove(player147.getID())==FAILURE);
assert(table.remove(player122.getID())==FAILURE);
assert(table.remove(player142.getID())==SUCCESS);
...
assert(table.remove(player82.getID())==SUCCESS);
assert(table.insert(player66.getID(), &player66)==FAILURE);
assert(table.insert(player27.getID(), &player27)==FAILURE);
assert(table.insert(player32.getID(), &player32)==FAILURE);
assert(table.remove(player9.getID())==FAILURE);
assert(table.find(player71.getID())!=nullptr);
assert(table.insert(player97.getID(), &player97)==SUCCESS);
...
assert(table.remove(player41.getID())==SUCCESS);
assert(table.remove(player90.getID())==SUCCESS);
assert(table.remove(player136.getID())==FAILURE);
assert(table.remove(player90.getID())==FAILURE);
assert(table.find(player51.getID())!=nullptr);
assert(table.find(player24.getID())!=nullptr);
assert(table.remove(player25.getID())==SUCCESS);
...
assert(table.insert(player71.getID(), &player71)==FAILURE);
assert(table.remove(player130.getID())==SUCCESS);
assert(table.remove(player140.getID())==FAILURE);
assert(table.find(player108.getID())!=nullptr);
assert(table.remove(player116.getID())==FAILURE);
assert(table.find(player80.getID())==nullptr);
assert(table.remove(player95.getID())==SUCCESS);
...
assert(table.insert(player63.getID(), &player63)==SUCCESS);
assert(table.insert(player85.getID(), &player85)==FAILURE);
assert(table.insert(player101.getID(), &player101)==FAILURE);
assert(table.remove(player140.getID())==FAILURE);
assert(table.remove(player20.getID())==FAILURE);
assert(table.insert(player62.getID(), &player62)==SUCCESS);
assert(table.insert(player97.getID(), &player97)==FAILURE);
...
assert(table.remove(player149.getID())==SUCCESS);
assert(table.find(player95.getID())==nullptr);
assert(table.remove(player107.getID())==FAILURE);
assert(table.remove(player115.getID())==FAILURE);
assert(table.find(player22.getID())==nullptr);
...
assert(table.insert(player118.getID(), &player118)==FAILURE);
assert(table.find(player68.getID())==nullptr);
assert(table.remove(player121.getID())==FAILURE);
assert(table.insert(player61.getID(), &player61)==SUCCESS);
assert(table.remove(player142.getID())==SUCCESS);
assert(table.insert(player112.getID(), &player112)==FAILURE);
assert(table.find(player37.getID())!=nullptr);
assert(table.remove(player59.getID())==SUCCESS);
...
assert(table.insert(player47.getID(), &player47)==FAILURE);
assert(table.remove(player145.getID())==FAILURE);
assert(table.insert(player144.getID(), &player144)==FAILURE);
assert(table.insert(player5.getID(), &player5)==FAILURE);
assert(table.find(player65.getID())==nullptr);
assert(table.remove(player101.getID())==FAILURE);
assert(table.remove(player97.getID())==SUCCESS);
...
assert(table.find(player43.getID())==nullptr);
assert(table.remove(player62.getID())==SUCCESS);
assert(table.insert(player146.getID(), &player146)==FAILURE);
assert(table.find(player137.getID())==nullptr);
assert(table.find(player86.getID())==nullptr);
assert(table.find(player122.getID())==nullptr);
assert(table.find(player95.getID())!=nullptr);
...
assert(table.remove(player48.getID())==FAILURE);
assert(table.insert(player19.getID(), &player19)==FAILURE);
assert(table.remove(player114.getID())==FAILURE);
assert(table.find(player49.getID())==nullptr);
assert(table.find(player51.getID())==nullptr);
assert(table.insert(player101.getID(), &player101)==SUCCESS);
assert(table.remove(player15.getID())==FAILURE);
...
assert(table.find(player113.getID())==nullptr);
assert(table.remove(player35.getID())==FAILURE);
assert(table.remove(player7.getID())==FAILURE);
assert(table.insert(player15.getID(), &player15)==SUCCESS);
assert(table.remove(player107.getID())==SUCCESS);
assert(table.insert(player103.getID(), &player103)==SUCCESS);
assert(table.insert(player95.getID(), &player95)==SUCCESS);
...
assert(table.find(player100.getID())!=nullptr);
assert(table.insert(player123.getID(), &player123)==FAILURE);
assert(table.insert(player2.getID(), &player2)==FAILURE);
assert(table.find(player50.getID())!=nullptr);
assert(table.remove(player56.getID())==SUCCESS);
assert(table.insert(player142.getID(), &player142)==FAILURE);
assert(table.insert(player123.getID(), &player123)==FAILURE);
...
assert(table.find(player16.getID())!=nullptr);
assert(table.remove(player91.getID())==SUCCESS);
assert(table.insert(player6.getID(), &player6)==FAILURE);
assert(table.remove(player121.getID())==FAILURE);
assert(table.insert(player25.getID(), &player25)==FAILURE);
assert(table.insert(player51.getID(), &player51)==SUCCESS);
assert(table.remove(player110.getID())==SUCCESS);
...
assert(table.find(player31.getID())==nullptr);
assert(table.insert(player116.getID(), &player116)==SUCCESS);
assert(table.insert(player129.getID(), &player129)==FAILURE);
assert(table.insert(player26.getID(), &player26)==SUCCESS);
assert(table.find(player57.getID())!=nullptr);
assert(table.find(player104.getID())!=nullptr);
assert(table.insert(player76.getID(), &player76)==SUCCESS);
...
assert(table.find(player104.getID())==nullptr);
assert(table.find(player24.getID())==nullptr);
assert(table.insert(player149.getID(), &player149)==FAILURE);
assert(table.insert(player56.getID(), &player56)==SUCCESS);
...
assert(table.remove(player117.getID())==SUCCESS);
assert(table.find(player114.getID())!=nullptr);
assert(table.remove(player123.getID())==FAILURE);
assert(table.find(player142.getID())!=nullptr);
assert(table.find(player111.getID())!=nullptr);
assert(table.find(player94.getID())!=nullptr);
assert(table.remove(player96.getID())==SUCCESS);
...
assert(table.find(player135.getID())!=nullptr);
assert(table.insert(player61.getID(), &player61)==FAILURE);
assert(table.insert(player70.getID(), &player70)==FAILURE);
assert(table.find(player32.getID())==nullptr);
assert(table.find(player50.getID())!=nullptr);
assert(table.insert(player138.getID(), &player138)==SUCCESS);
assert(table.insert(player54.getID(), &player54)==FAILURE);
...
assert(table.remove(player97.getID())==SUCCESS);
assert(table.insert(player125.getID(), &player125)==SUCCESS);
assert(table.remove(player141.getID())==FAILURE);
assert(table.insert(player132.getID(), &player132)==SUCCESS);
assert(table.find(player123.getID())==nullptr);
assert(table.remove(player1.getID())==FAILURE);
assert(table.remove(player79.getID())==SUCCESS);
...
assert(table.remove(player143.getID())==SUCCESS);
assert(table.remove(player46.getID())==SUCCESS);
assert(table.insert(player8.getID(), &player8)==FAILURE);
assert(table.remove(player108.getID())==FAILURE);
assert(table.remove(player96.getID())==FAILURE);
assert(table.find(player29.getID())==nullptr);
assert(table.find(player84.getID())==nullptr);
...
assert(table.remove(player25.getID())==SUCCESS);
assert(table.remove(player132.getID())==FAILURE);
assert(table.insert(player122.getID(), &player122)==FAILURE);
assert(table.remove(player62.getID())==FAILURE);
assert(table.insert(player58.getID(), &player58)==SUCCESS);
assert(table.find(player131.getID())==nullptr);
assert(table.insert(player64.getID(), &player64)==FAILURE);
...
assert(table.find(player135.getID())!=nullptr);
assert(table.remove(player138.getID())==SUCCESS);
assert(table.remove(player126.getID())==FAILURE);
assert(table.remove(player22.getID())==SUCCESS);
assert(table.remove(player58.getID())==SUCCESS);
assert(table.insert(player10.getID(), &player10)==SUCCESS);
assert(table.find(player30.getID())==nullptr);
...
assert(table.insert(player69.getID(), &player69)==SUCCESS);
assert(table.insert(player79.getID(), &player79)==FAILURE);
assert(table.remove(player104.getID())==FAILURE);
assert(table.remove(player11.getID())==SUCCESS);
assert(table.find(player94.getID())!=nullptr);
assert(table.remove(player79.getID())==SUCCESS);
assert(table.remove(player60.getID())==SUCCESS);
...
assert(table.remove(player118.getID())==FAILURE);
assert(table.insert(player77.getID(), &player77)==SUCCESS);
assert(table.insert(player143.getID(), &player143)==FAILURE);
assert(table.remove(player138.getID())==FAILURE);
assert(table.insert(player53.getID(), &player53)==SUCCESS);
assert(table.insert(player26.getID(), &player26)==SUCCESS);
assert(table.find(player21.getID())==nullptr);
...
assert(table.remove(player125.getID())==FAILURE);
assert(table.insert(player38.getID(), &player38)==FAILURE);
assert(table.insert(player3.getID(), &player3)==FAILURE);
assert(table.insert(player60.getID(), &player60)==FAILURE);
assert(table.insert(player8.getID(), &player8)==FAILURE);
assert(table.remove(player80.getID())==SUCCESS);
assert(table.remove(player52.getID())==FAILURE);
...
assert(table.remove(player48.getID())==FAILURE);
assert(table.remove(player139.getID())==SUCCESS);
assert(table.insert(player145.getID(), &player145)==FAILURE);
assert(table.insert(player148.getID(), &player148)==FAILURE);
assert(table.remove(player95.getID())==FAILURE);
assert(table.find(player96.getID())==nullptr);
assert(table.remove(player41.getID())==FAILURE);
...
assert(table.find(player70.getID())==nullptr);
assert(table.insert(player94.getID(), &player94)==FAILURE);
assert(table.insert(player23.getID(), &player23)==FAILURE);
assert(table.insert(player84.getID(), &player84)==SUCCESS);
assert(table.insert(player94.getID(), &player94)==FAILURE);
assert(table.find(player88.getID())!=nullptr);
assert(table.insert(player54.getID(), &player54)==SUCCESS);
...
assert(table.remove(player129.getID())==SUCCESS);
assert(table.insert(player35.getID(), &player35)==SUCCESS);
assert(table.remove(player110.getID())==FAILURE);
assert(table.insert(player124.getID(), &player124)==SUCCESS);
assert(table.remove(player146.getID())==SUCCESS);
assert(table.insert(player69.getID(), &player69)==FAILURE);
assert(table.find(player62.getID())==nullptr);
...
assert(table.find(player81.getID())==nullptr);
assert(table.find(player137.getID())==nullptr);
assert(table.remove(player105.getID())==FAILURE);
assert(table.remove(player35.getID())==SUCCESS);
assert(table.find(player109.getID())==nullptr);
assert(table.remove(player96.getID())==SUCCESS);
assert(table.remove(player137.getID())==FAILURE);
...
assert(table.remove(player121.getID())==FAILURE);
assert(table.find(player12.getID())!=nullptr);
assert(table.remove(player109.getID())==FAILURE);
assert(table.remove(player6.getID())==FAILURE);
assert(table.insert(player36.getID(), &player36)==SUCCESS);
assert(table.insert(player72.getID(), &player72)==FAILURE);
assert(table.remove(player124.getID())==FAILURE);
...
assert(table.insert(player144.getID(), &player144)==FAILURE);
assert(table.insert(player110.getID(), &player110)==FAILURE);
assert(table.insert(player113.getID(), &player113)==FAILURE);
assert(table.remove(player18.getID())==FAILURE);
assert(table.insert(player37.getID(), &player37)==FAILURE);
assert(table.insert(player126.getID(), &player126)==SUCCESS);
assert(table.find(player92.getID())==nullptr);
...
assert(table.insert(player124.getID(), &player124)==FAILURE);
assert(table.remove(player145.getID())==FAILURE);
assert(table.insert(player139.getID(), &player139)==FAILURE);
assert(table.remove(player107.getID())==SUCCESS);
assert(table.insert(player109.getID(), &player109)==SUCCESS);
assert(table.find(player104.getID())==nullptr);
assert(table.insert(player5.getID(), &player5)==SUCCESS);
...
assert(table.insert(player127.getID(), &player127)==SUCCESS);
assert(table.find(player111.getID())==nullptr);
assert(table.remove(player65.getID())==FAILURE);
assert(table.find(player148.getID())!=nullptr);
assert(table.insert(player134.getID(), &player134)==SUCCESS);
assert(table.find(player86.getID())!=nullptr);
assert(table.insert(player117.getID(), &player117)==FAILURE);
...
assert(table.insert(player12.getID(), &player12)==FAILURE);
assert(table.insert(player36.getID(), &player36)==SUCCESS);
assert(table.insert(player125.getID(), &player125)==FAILURE);
assert(table.find(player57.getID())!=nullptr);
assert(table.find(player49.getID())==nullptr);
assert(table.remove(player30.getID())==SUCCESS);
assert(table.remove(player36.getID())==SUCCESS);
...
assert(table.remove(player125.getID())==SUCCESS);
assert(table.find(player18.getID())==nullptr);
assert(table.insert(player147.getID(), &player147)==FAILURE);
assert(table.insert(player143.getID(), &player143)==FAILURE);
assert(table.find(player8.getID())==nullptr);
assert(table.insert(player38.getID(), &player38)==SUCCESS);
assert(table.remove(player48.getID())==SUCCESS);
...
assert(table.remove(player86.getID())==FAILURE);
assert(table.remove(player143.getID())==SUCCESS);
assert(table.remove(player100.getID())==FAILURE);
assert(table.remove(player8.getID())==SUCCESS);
assert(table.remove(player61.getID())==FAILURE);
assert(table.remove(player66.getID())==SUCCESS);
assert(table.insert(player54.getID(), &player54)==SUCCESS);
...
assert(table.remove(player80.getID())==SUCCESS);
assert(table.find(player58.getID())==nullptr);
assert(table.remove(player134.getID())==FAILURE);
assert(table.insert(player48.getID(), &player48)==SUCCESS);
assert(table.insert(player7.getID(), &player7)==FAILURE);
assert(table.remove(player59.getID())==FAILURE);
assert(table.insert(player8.getID(), &player8)==SUCCESS);
...
assert(table.remove(player148.getID())==FAILURE);
assert(table.remove(player60.getID())==SUCCESS);
assert(table.remove(player120.getID())==FAILURE);
assert(table.find(player110.getID())!=nullptr);
assert(table.remove(player106.getID())==FAILURE);
assert(table.remove(player76.getID())==SUCCESS);
assert(table.insert(player31.getID(), &player31)==SUCCESS);
...
assert(table.insert(player7.getID(), &player7)==FAILURE);
assert(table.insert(player102.getID(), &player102)==SUCCESS);
assert(table.insert(player49.getID(), &player49)==FAILURE);
assert(table.insert(player34.getID(), &player34)==FAILURE);
assert(table.remove(player69.getID())==FAILURE);
assert(table.find(player99.getID())==nullptr);
assert(table.remove(player74.getID())==FAILURE);
